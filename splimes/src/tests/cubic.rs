...
mod tests {
	...
	use crate::{
		Resolution, TargetTimesIterator, auto_interpolate, cubic, gpu_interpolate, parallel_interpolate, tests::linear::tests::{COS_THRESHOLD, POINTS, RESOLUTION, Z_THRESHOLD, check_similarity}
	};

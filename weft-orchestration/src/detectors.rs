...
//!
//! ```ignore
//! use weft_orchestration::detectors;
...
//!
//! ```ignore
//! use weft_orchestration::{Event, Manifestation, EventDetector, event_detector_fn};
//! use weftdb::{Database, AspectId, Resolution, DatabaseStructure, Outputs};
//! use splimes::Spline;
//! use anyhow::Result;
//!

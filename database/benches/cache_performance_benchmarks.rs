        ...
        b.iter(|| {
            rt.block_on(async {
                ...
                let measurement = InputMeasurement::new(
                    ...
                    BigDecimal::from_str(&format!("{}.0", counter % 100)).unwrap()
                );
                    ...
                    let tasks: Vec<_> = (0..concurrency)
                        .map(|i| {
                            ...
                            tokio::spawn(async move { 
                                analyze_point(aspect_id, target_time, Resolution::Seconds, SplineType::Linear).await.unwrap() 
                            })
                        })
                        .collect();

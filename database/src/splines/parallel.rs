...
pub fn optimized_interpolate(
    ...
    match (measurement_count, output_points) {
        ...
        (201..=1000, 512..) => {
            super::simd::auto_interpolate_simd(&measurements, &target_times, spline_type)
        }
        
        // Large datasets and all other cases - use parallel
        _ => {
            parallel_interpolate(measurements, start, end, resolution, spline_type)
        }
    }
}

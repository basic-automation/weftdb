...
- **Restore, with a drill.** `database::restore_control_plane(backup_dir, root)`
  ...
  reopens the restored root and reads its measurements back. *(Library primitive —

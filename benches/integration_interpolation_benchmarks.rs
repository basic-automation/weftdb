...
criterion_group!(integration_benches, bench_auto_interpolate_with_different_data_sizes, bench_auto_interpolate_spline_comparison, bench_auto_interpolate_resolution_comparison);

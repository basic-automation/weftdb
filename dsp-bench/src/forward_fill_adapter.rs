...
//! report, where possible, the **native in-DB gap-fill** behaviour alongside DSP's
...
//! engine behind it — so a DSP-Bench comparison can carry DSP's interpolation
...
//!   That is the whole point of a *baseline*: comparing DSP's chosen method against
...
//!   harness correctness gate exactly as the DSP path does.
//!

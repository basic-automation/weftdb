...
mod tests {
    ...
    fn test_linear_multiple_segments() {
        ...
        let measurements = vec![
            ...
            create_measurement(dataset_id, Utc.with_ymd_and_hms(2023, 1, 1, 0, 0, 20).unwrap(), 30.0)
        ];
    ...
    fn test_identical_timestamps() {
        ...
        let measurements = vec![
            create_measurement(dataset_id, Utc.with_ymd_and_hms(2023, 1, 1, 0, 0, 0).unwrap(), 10.0), 
            create_measurement(dataset_id, Utc.with_ymd_and_hms(2023, 1, 1, 0, 0, 0).unwrap(), 20.0)
        ];
    ...
    fn test_different_resolutions() {
        ...
        let measurements = vec![
            create_measurement(dataset_id, Utc.with_ymd_and_hms(2023, 1, 1, 0, 0, 0).unwrap(), 0.0), 
            create_measurement(dataset_id, Utc.with_ymd_and_hms(2023, 1, 1, 1, 0, 0).unwrap(), 60.0)
        ];
